...
import {setMemory, applyNumber, changeOperation, clearDisplay, callMemory, clearMemory} from './actions/index';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={handleCallMemory}/>
              <CalcButton value={"MC"} onClick={handleClearMemory}/>
            </div>

            <div className="row">
              <CalcButton value={1} onClick={() => handleNumClick(1)/*dispatch(addOne())*/}/>
            ...
            <div className="row">
              ...
              <CalcButton value={8} onClick={() => handleNumClick(7)}/>
              <CalcButton value={9} onClick={() => handleNumClick(9)}/>
            </div>
            <div className="row">
              <CalcButton value={"+"} onClick={() => handleChangeOperation("+")} /*dispatch(changeOperation("+"))*//>
